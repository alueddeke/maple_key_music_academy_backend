...
class StudentInvoicePDFGenerator:
    ...
    def generate_pdf(self):
        ...
        try:
            ...
            # Items table
            # Table data - now showing individual lessons like teacher PDF
            data = [['Description', 'Date', 'Duration (hrs)', 'Amount']]

            # Add each lesson as a separate row
            for lesson in self.student_lessons:
                ...
                items_text = f"<b>{lesson_type_label}</b>"
